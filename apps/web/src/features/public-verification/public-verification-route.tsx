    ...
    <Card className="min-w-0 border-border-default bg-surface-muted shadow-none">
      <CardHeader className="flex-row items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 max-w-2xl text-sm leading-6 text-text-muted">La huella canónica es un identificador criptográfico calculado por Traza a partir de la versión emitida de la credencial. Si los datos emitidos cambian, la huella resultante también cambia.</p>
