...
export function WalletHomeView({ profileState, credentialsState, showProfileShare = false, onRetryProfile, onProfileRebuilt }: { profileState: HolderProfileLoadState; credentialsState: HolderCredentialsLoadState; showProfileShare?: boolean; onRetryProfile?: () => void; onProfileRebuilt?: (profile: HolderProfileVM | null) => void }) {
