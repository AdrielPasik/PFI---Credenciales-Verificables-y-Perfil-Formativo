# -*- coding: utf-8 -*-
"""P2.1 - Candidato OU_A1: prompt y schema estructurado.
...
- Si extender la cita de forma contigua resulta inviable, quita la modalidad del texto
  propuesto y cita solo la vineta.
