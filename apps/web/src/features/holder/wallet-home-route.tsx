...
function WalletHomeContent() {
  ...
  return <WalletHomeView profileState={profileState} credentialsState={credentialsState} />;
}

export function WalletHomeView({ profileState, credentialsState }: { profileState: HolderProfileLoadState; credentialsState: HolderCredentialsLoadState }) {
