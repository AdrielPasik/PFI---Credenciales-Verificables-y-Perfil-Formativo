# -*- coding: utf-8 -*-
"""P2.1 - Candidato OU_A0: prompt y schema estructurado congelados.
...
- Si afirmas modalidad en el texto propuesto ("Deseable: ...", "No excluyente: ..."), la cita
  primaria DEBE abarcar el texto que establece esa modalidad. Si el encabezado que la establece
  no es contiguo con la vineta, quita la modalidad del texto propuesto.
